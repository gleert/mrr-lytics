...
const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-07-30',
    changes: [
      { type: 'fix', text: 'changelog.entries.v2185.movementWindowMonthShift' },
    ],
  },
  {
    version: '2.18.4',
    date: '2026-07-07',
    changes: [
      { type: 'fix', text: 'changelog.entries.v2184.domainsLostTransferredAway' },
    ],
  },
  {
    version: '2.18.3',
    date: '2026-07-07',
    changes: [
      { type: 'fix', text: 'changelog.entries.v2183.domainStatusFilterAll' },
    ],
  },
  {
    version: '2.18.2',
    date: '2026-06-30',
    changes: [
      { type: 'fix', text: 'changelog.entries.v2182.domainBackfillNotNew' },
    ],
  },
  {
    version: '2.18.1',
  ...
  },
  {
    ...
    date: '2026-06-17',
    changes: [
      { type: 'improvement', text: 'changelog.entries.v2180.domainsGainedExcludeCancelled' },
    ],
  },
  {
    version: '2.17.1',
    date: '2026-06-11',
    changes: [
      { type: 'improvement', text: 'changelog.entries.v2171.domainsGainedTooltip' },
    ],
  },
  {
    version: '2.17.0',
    date: '2026-06-11',
    changes: [
      { type: 'feature', text: 'changelog.entries.v2170.domainsMonthlyChart' },
    ],
  },
  {
    version: '2.16.0',
    date: '2026-06-11',
    changes: [
      { type: 'feature', text: 'changelog.entries.v2160.reactivationPill' },
    ],
  },
  {
    version: '2.15.0',
  ...
  },
  {
    ...
    date: '2026-06-05',
    changes: [
      { type: 'feature', text: 'changelog.entries.v2140.expansionContractionDrilldown' },
    ],
  },
  {
    version: '2.13.0',
    date: '2026-06-04',
    changes: [
      { type: 'improvement', text: 'changelog.entries.v2130.dailyMrrReal' },
    ],
  },
  {
    version: '2.12.3',
  ...
  },
  {
    ...
    date: '2026-05-27',
    changes: [
      { type: 'fix',         text: 'changelog.entries.v2121.domainSyncReliability' },
      { type: 'improvement', text: 'changelog.entries.v2121.ledgerDefaultSort' },
    ],
  },
  {
    version: '2.12.0',
    date: '2026-05-26',
    changes: [
      { type: 'feature', text: 'changelog.entries.v2120.mrrByVintage' },
    ],
  },
  {
    version: '2.11.0',
    date: '2026-05-21',
    changes: [
      { type: 'feature', text: 'changelog.entries.v2110.ledgerReport' },
      { type: 'feature', text: 'changelog.entries.v2110.ledgerDownloadButtons' },
    ],
  },
  {
    version: '2.10.0',
