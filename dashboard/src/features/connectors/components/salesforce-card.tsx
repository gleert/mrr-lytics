...
import type { SalesforceConnector } from '../hooks/use-connectors'
...
export function SalesforceCard({
  connector,
  onEdit,
  onTest,
  onDelete,
  ...
  // Extract instance name from URL for display
  const instanceName = connector.config.instance_url
    ? new URL(connector.config.instance_url).hostname.split('.')[0]
    : 'Salesforce CRM'
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted">{instanceName}</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              title={t('connectors.testSalesforce')}
            >
              {isTestLoading
