...
import type { ZapierConnector } from '../hooks/use-connectors'
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted">Zapier Catch Hook</p>
            </div>
          </div>
        </div>
