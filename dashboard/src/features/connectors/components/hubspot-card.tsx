...
import type { HubspotConnector } from '../hooks/use-connectors'
...
export function HubspotCard({
  ...
  const subtitle = connector.config.portal_id
    ? `Portal ${connector.config.portal_id}`
    : 'HubSpot CRM'
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              title={t('connectors.testHubspot')}
            >
              {isTestLoading
