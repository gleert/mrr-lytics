export default {
  ...
  hero: {
    ...
    socialProof: 'Sin coste de alta • Cancela cuando quieras • Conecta tu WHMCS en minutos',
    // Dashboard mock
    mrr: 'MRR',
  ...
  pricing: {
    ...
    subtitle: 'Elige el plan que mejor encaje con tu negocio de hosting. Sin costos ocultos, cancela cuando quieras.',
    mostPopular: 'Más Popular',
    perMonth: '/mes',
    plans: {
      starter: {
        name: 'Starter',
        description: 'Para negocios de hosting pequeños',
        features: [
      ...
      advanced: {
        name: 'Advanced',
        description: 'Para hosters en crecimiento',
        features: [
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: '¡Sí! El número de instancias de WHMCS que puedes conectar depende de tu plan. Starter permite 1, Advanced permite 2, Pro permite 5, y Business tiene instancias ilimitadas.',
      },
      {
