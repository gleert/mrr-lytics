export default {
  ...
  hero: {
    ...
    socialProof: 'No setup fees • Cancel anytime • Connect your WHMCS in minutes',
    // Dashboard mock
    mrr: 'MRR',
  ...
  pricing: {
    ...
    subtitle: 'Pick the plan that fits your hosting business. No hidden fees, cancel anytime.',
    ...
    plans: {
      ...
      advanced: {
        name: 'Advanced',
        description: 'For growing hosting providers',
        features: [
          'Up to 2,500 clients',
          '2 WHMCS instances',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Yes! The number of WHMCS instances you can connect depends on your plan. Starter allows 1, Advanced allows 2, Pro allows 5, and Business has unlimited instances.',
      },
      {
